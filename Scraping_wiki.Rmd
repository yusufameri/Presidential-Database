...
### Scrape Gallop Polling Data
```{r}
expectation_polls <- read.csv("historical_national_expectation_polls.csv",header = TRUE)
intention_polls <- read.csv("historical_national_intention_polls.csv",header = TRUE)
```
