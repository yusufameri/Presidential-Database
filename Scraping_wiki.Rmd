...
# create tables
write("CREATE TABLE presidential_elections.election (year INTEGER NOT NULL, winner VARCHAR(64), num INTEGER);",  electionFile, append = TRUE)
write("CREATE TABLE presidential_elections.participated (year INTEGER NOT NULL, candidate VARCHAR(64), party VARCHAR(64), electoral_vote INTEGER, popular_vote INTEGER, vice_president VARCHAR(64));",  participatedFile, append = TRUE)
